...
const icons: Record<IconName, React.ReactNode> = {
  ...
  map: (
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M9 6.75V15m0-8.25a2.25 2.25 0 112.25 2.25H9m0-4.5H5.625c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V5.625c0-.621-.504-1.125-1.125-1.125H15M9 6.75h6m0 0v2.25m0-2.25a2.25 2.25 0 112.25 2.25H15"
    />
  ),
  globe: (
    <path
...
export function Icon({ name, size = 'md', strokeWidth = 2, className = '', ...props }: IconProps) {
